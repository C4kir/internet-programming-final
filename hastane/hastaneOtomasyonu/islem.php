...
if (isset($_POST['kullanicikaydet'])) {
    ...
    $sorgu = $conn->prepare('INSERT INTO kullanici SET
    kullanici_tc = ?,
    kullanici_adsoyad = ?,
    kullanici_password = ?
    ');
...
if(isset($_POST['giris_yap'])){
    ...
    $kullanicisor = $conn->prepare("SELECT * FROM kullanici WHERE kullanici_tc=:kullanici_tc and kullanici_password=:kullanici_password");
...
if (isset($_POST['randevu_kaydet'])) {
    ...
    $kaydet = $conn->prepare("INSERT INTO randevu SET
        randevu_sehir = ?,
        randevu_hastane = ?,
        randevu_doktor = ?,
        randevu_tarih = ?,
    ...
    if ($insert) {
        ...
        header("location:index.php?kayıt_basarisiz");
    }
}
